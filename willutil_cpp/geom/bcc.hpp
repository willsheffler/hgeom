...
#include "willutil_cpp/util/str.hpp"
...
struct BCC {
  ...
  //  void neighbors_6_3(I index, Iiter &iter, int rad, bool exhalf, bool
  //  oddlast3,
  //                     bool sphere) const noexcept {
  //    bool odd = index & 1;
  ...
  //
  //                bool inoddlast3 = i5 + l3shift || i4 + l3shift || i3 +
  //                l3shift; bool skip0 = inoddlast3 && !odd; bool skip1 =
  //                inoddlast3 && odd;
  //
  //                if (!skip0) {
  ...
  //  }
  //  // template <typename Iiter>
  //  // std::enable_if_t<DIM != 3> neighbors_3(I index, Iiter &iter, int const
  //  rad,
  //  //                                        bool const exhalf,
  //  //                                        bool const sphere) const
  //  noexcept {}
  //  // template <typename Iiter, typename = std::enable_if_t<DIM != 3>>
  //  // void neighbors_3(I index, Iiter &iter, int const rad, bool const
  //  exhalf,
