...
import numpy as np
from hgeom import Xbin_double, Xbin_float, create_Xbin_nside_double
from hgeom.homog import angle_of
...
def test_xbin_covrad(niter=20, nsamp=500):
